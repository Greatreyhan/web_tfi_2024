    ...
    useEffect(() => {
      ...
      onValue(query, (snapshot) => {
        ...
        if (snapshot.exists()) {
          ...
          else setCO2([500+(Math.random()*500).toFixed(2)])
        }
      });
      ...
      onValue(query, (snapshot) => {
        ...
        if (snapshot.exists()) {
          ...
          else setCO([(100+(Math.random()*80)).toFixed(2)])
      }
      });
      ...
      onValue(query, (snapshot) => {
        ...
        if (snapshot.exists()) {
          ...
          else setC2H5OH([(50+(Math.random()*30)).toFixed(2)])
        }
      });
      ...
      onValue(query, (snapshot) => {
        ...
        if (snapshot.exists()) {
          ...
          else setH2([(60+(Math.random()*30)).toFixed(2)])
      }
      });
      ...
      onValue(query, (snapshot) => {
        ...
        if (snapshot.exists()) {
          ...
          else setCH4([(300+(Math.random()*30)).toFixed(2)])
        }
      });
      ...
      onValue(query, (snapshot) => {
        ...
        if (snapshot.exists()) {
          ...
          else setNH3([(50+(Math.random()*10)).toFixed(2)])
        }
      });
      ...
      onValue(query, (snapshot) => {
        ...
        if (snapshot.exists()) {
          ...
          else setNO2([(1+(Math.random()*1)).toFixed(2)])
        }
      });
      ...
      onValue(query, (snapshot) => {
        ...
        if (snapshot.exists()) {
          ...
          else setTemp([(23+(Math.random()*5)).toFixed(2)])
        }
        else setTemp([(23+(Math.random()*5)).toFixed(2)])
      });
      ...
      onValue(query, (snapshot) => {
        ...
        if (snapshot.exists()) {
          ...
          else setHumid([(30+(Math.random()*20)).toFixed(2)]);
        }
        else setHumid([(30+(Math.random()*20)).toFixed(2)]);
      });
...
export default Outputdatarandom